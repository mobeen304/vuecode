   ...
   <div class="kt-portlet__head-toolbar">
      <div class="kt-portlet__head-wrapper">
         <div class="kt-portlet__head-actions">
            ...
            &nbsp;
            <router-link to="/admin/newcustomers" class="btn btn-brand btn-elevate btn-icon-sm">
    ...
    <tbody>
        <tr v-for="val in rows">
          ...
          <td>{{val.billing_city}} {{val.billing_state}} {{val.billing_country}}</td>
             <td>
             <router-link :to="'/admin/customer/'+val.id" class="btn btn-sm btn-clean btn-icon btn-icon-md">   <i class="la la-edit"></i>
             </router-link> 
             <a title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md" @click="removeCustomer(val.id)"><i class="la la-trash"></i></a>
            </td>
        </tr>
    </tbody>
    <!---->
...
<script type="text/javascript">
    ...
    components: {
      'app-notify': notification
		...
		methods : {
			getList () {
				Customers.list({page:this.limit}).then(response=>{
          ...
          .then(function () {
             Customers.remove(id).then(response=>{
                   console.log(this)

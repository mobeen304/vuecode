   ...
   <div class="kt-portlet__head-toolbar">
      <div class="kt-portlet__head-wrapper">
         <div class="kt-portlet__head-actions">
            ...
            &nbsp;
            <router-link to="/admin/newcampaign" class="btn btn-brand btn-elevate btn-icon-sm">
    ...
    <tbody>
        <tr v-for="val in rows">
          ...
          <!-- <td>{{val.status}}</td> -->
             <td>
             <router-link :to="'/admin/lead/'+val.id" class="btn btn-sm btn-clean btn-icon btn-icon-md">   <i class="la la-edit"></i>
             </router-link> 
             <a title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md" @click="removeLead(val.id)"><i class="la la-trash"></i></a>
            </td>
        </tr>
    </tbody>
    <!---->
...
<script type="text/javascript">
    ...
    components: {
      'app-notify': notification
		...
		methods : {
			getList () {
				Contact.list({page:this.limit}).then(response=>{
          ...
          .then(function () {
             Contact.remove(id).then(response=>{
                   console.log(this)

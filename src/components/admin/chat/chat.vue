      ...
      <div class="kt-portlet kt-portlet--last">
         <div class="kt-portlet__body">
            ...
            <div class="kt-widget kt-widget--users kt-mt-20">
               <div class="kt-scroll kt-scroll--pull ps ps--active-y" style="height: 254px; overflow: hidden;">
                  <div class="kt-widget__items">
                     <div class="kt-widget__item" v-for="val in users">
                        <span class="kt-media kt-media--circle"> 
                        <!-- <img v-bind:src="'../../../'+val.profile_pic" alt="image"> -->
                        <img alt="Logo" v-bind:src="val.profile_pic">
                        </span>
                        <div class="kt-widget__info">
                           <div class="kt-widget__section">
                              <a href="#" class="kt-widget__username">{{val.name}}</a>
                  ...
                  <div class="ps__rail-y" style="top: 0px; height: 254px; right: -2px;">
   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-app__content" id="kt_chat_content">
      <div class="kt-chat">
         <div class="kt-portlet kt-portlet--head-lg kt-portlet--last">
               ...
               <div class="kt-chat__head ">
                  ...
                  <div class="kt-chat__center">
                     ...
                     <div class="kt-chat__pic kt-hidden">
                        ...
                        <img src="/metronic/themes/metronic/theme/default/demo9/dist/assets/media/users/300_12.jpg" alt="image">
                        </span>
                        ...
                        <img src="/metronic/themes/metronic/theme/default/demo9/dist/assets/media/users/300_11.jpg" alt="image">
                        </span>
                        ...
                        <img src="/metronic/themes/metronic/theme/default/demo9/dist/assets/media/users/100_14.jpg" alt="image">
                        </span>
                        ...
                        <img src="/metronic/themes/metronic/theme/default/demo9/dist/assets/media/users/100_4.jpg" alt="image">
                        </span>
                     </div>
                  </div>
            ...
            <div class="kt-portlet__body">
               <div class="kt-scroll kt-scroll--pull ps ps--active-y" data-mobile-height="300" style="height: 76px; overflow: hidden;">
                  ...
                  <div class="ps__rail-y" style="top: 0px; height: 76px; right: -2px;">

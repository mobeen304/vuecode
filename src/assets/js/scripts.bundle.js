...
var KTLayout = function() {
    ...
    return {
        init: function() {
            KTUtil.get("body"), this.initHeader(), this.initAside(), this.initPageStickyPortlet(), $("#kt_aside_menu, #kt_header_menu").on("click", '.kt-menu__link[href="#"]', function(t) {
        ...
        initHeader: function() {
            ...
            n = KTUtil.get("kt_header"), (o = {
                ...
                offset: {},
                minimize: {}
            }).minimize.mobile = !1, "on" == KTUtil.attr(n, "data-ktheader-minimize") ? (o.minimize.desktop = {}, o.minimize.desktop.on = "kt-header--minimize", o.offset.desktop = parseInt(KTUtil.css(n, "height")) - 10) : o.minimize.desktop = !1, t = new KTHeader("kt_header", o), a && (t.on("minimizeOn", function() {
                a.scrollReInit()
        ...
        initAside: function() {
            ...
            }), o = KTUtil.get("kt_aside_menu"), i = "1" === KTUtil.attr(o, "data-ktmenu-dropdown") ? "dropdown" : "accordion", "1" === KTUtil.attr(o, "data-ktmenu-scroll") && (n = {
                rememberPosition: !0,
                height: function() {
        ...
        initPageStickyPortlet: function() {
            KTUtil.get("kt_page_portlet") && ((n = o()).initSticky(), KTUtil.addResizeHandler(function() {
                n.updateSticky()
            }), o())
        },
